function GroupTabs({ groups, activeGroup, onSelect, groupingDimension, onDimensionChange }) {
  return (
    <div className="mb-4">
      {/* 维度切换器 - 独立的突出控件 */}
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg mb-3 px-4 py-3">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
                groupingDimension === 'custom'
                  ...
                  : 'text-gray-600 dark:text-gray-300 hover:text-gray-900 hover:bg-white dark:bg-gray-800/50'
              }`}
            >
              按分组
            </button>
